...
class Spiri(object):
  ...
  def get_accel_data(self):
    ...
    if func_code != FUNCTION_CODE:
      return (res,ThreeAxis(0, 0, 0))
    (res,) = struct.unpack_from( '!i', input_buffer,  param_offset )
    (x,) = struct.unpack_from( '!f', input_buffer,  param_offset + 4 )
    (y,) = struct.unpack_from( '!f', input_buffer,  param_offset + 8 )
    (z,) = struct.unpack_from( '!f', input_buffer,  param_offset + 12 )
  ...
  def get_temperature_data(self):
    ...
    if func_code != FUNCTION_CODE:
      return (res, 0.0)
    (res,) = struct.unpack_from( '!i', input_buffer,  param_offset )
    (sensor_data,) = struct.unpack_from( '!f', input_buffer,  param_offset + 4 )
  ...
  def get_attitude_readings(self):
    ...
    if func_code != FUNCTION_CODE:
      return (res, 0, 0, 0, 0)
    (res,) = struct.unpack_from( '!i', input_buffer,  param_offset )
    (a,) = struct.unpack_from( '!f', input_buffer,  param_offset + 4 )
    (b,) = struct.unpack_from( '!f', input_buffer,  param_offset + 8 )
  ...
  def get_stabilization_data(self):
    ...
    if func_code != FUNCTION_CODE:
      return (res,ThreeAxis(0, 0, 0))
    (res,) = struct.unpack_from( '!i', input_buffer,  param_offset )
    (p,) = struct.unpack_from( '!f', input_buffer,  param_offset + 4 )
    (i,) = struct.unpack_from( '!f', input_buffer,  param_offset + 8 )
    (d,) = struct.unpack_from( '!f', input_buffer,  param_offset + 12 )
  ...
  def get_all_sensor_data(self):
    ...
    (acoustic_range,) = struct.unpack_from( '!f', input_buffer,  param_offset + 40)
    (pressure,) = struct.unpack_from( '!f', input_buffer,  param_offset + 44 )
  ...
  def get_GPS(self):
    ...
    (y,) = struct.unpack_from( '!f', input_buffer,  param_offset + 8 )
    (z,) = struct.unpack_from( '!f', input_buffer,  param_offset + 12 )
    (UTC_time,) = struct.unpack_from( '!f', input_buffer,  param_offset + 16 )
